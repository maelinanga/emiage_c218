    ...
    */
    ...
    public Iterable <Employee> getEmployees() {
         ...
         * n appelle la méthode exchange en transmettant :l’URL ;
			...
			le type retour, ici je suis obligé d’utiliser un objet ParameterizedTypeReference car /employees 
	...
	public Employee getUserBylogin(String user) {
		String baseApiUrl = props.getApiUrl();
		String getEmployeeUrl = baseApiUrl + "/loginemployee/" + user;
